...
main_buttons = [[
    InlineKeyboardButton('🇮🇳 Cʀᴇᴀᴛᴏʀ :', url='https://t.me/AV_King1')
],[
    InlineKeyboardButton('👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴜs', url='https://t.me/AV_King1'),
    InlineKeyboardButton('💝 ᴍᴏᴠɪᴇ sᴇᴀʀᴄʜ ɢʀᴏᴜᴘ', url='https://t.me/+f4pYcQbroY5mM2E9')
],[
    InlineKeyboardButton('⚜️ sᴜʙsᴄʀɪʙᴇ ᴍʏ ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ', url='https://t.me/MOVIES_WORLDZS')
],[
